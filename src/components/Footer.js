          ...
          <div className="row">
            <div className="col-5">
              <div className="footer-top-data d-flex gap-15 align-items-center">
                ...
                <h2 className="mb-0 text-white">Sign Up now</h2>
              </div>
            </div>
            <div className="col-7">
            <div className="input-group mb-3">
                <input type="text" className="form-control py-1" placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="basic-addon2"/>
            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">
                  Metro Manila, Phillipines <br />
                  Zipcode:1770
                </address>
                <a href="tel:+63 9123456789" className="mt-4 d-block mb-0 text-white">+63 9123456789</a><br />
                <a href="mailto:ammgadget@gmail.com" className="mt-4 d-block mb-3 text-white">ammgadget@gmail.com</a>
      ...
      <footer className="py-4">
        <div className="col-12">
          <p className="text-center mb-0 text-white">
            &copy: {new Date().getFullYear()};Powered by Ammgadget
          </p>
        </div>
        </footer>
    </>
