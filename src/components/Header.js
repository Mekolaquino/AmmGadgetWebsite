  ...
  return (
    ...
    <header className="header-top-strip py-3">
      <div className="container-xxl">
        <div className="row">
          <div className="col-6">
            <p className="text-white mb-0">Free Shipping Over P100 </p>
          </div>
          <div className="col-6">
            <p className="text-end text-white mb-0">ContactUs: <a href="tel:+63 9123465789">09123456789</a>
            </p>
          </div>
        </div>
      </div>
    ...
    <header className="header-upper py-3">
      <div className="conainer-xxl">
        <div className="row align-items-center">
          <div className="col-2">
            <h2>
              <Link className="text-white">Gadget</Link>
            </h2>
          </div>
          <div className="col-3">
            ...
            <div className="header-upper-links d-flex align-items-center justify-content-between">
              ...
              <div>
                <Link className="d-flex align-items-center gap-10 text-white">
                  ...
                  <p className="mb-0">LogIn <br/> MyAcc</p>
                </Link>
              </div>
              <div>
                <Link className="d-flex align-items-center gap-10 text-white">
    ...
    <header className="header-botton py-3">
      <div className="row">
        <div className="col-12">
          <div className="menu-botton d-flex align-items-center gap-15">
            <div>
            <div class="dropdown">
              ...
              aria-expanded="false">
                ...
                <span className="me-5 inline-block">Shop Caegories</span>
              </button>
